...
{
    internal class AzureADOptionsConfiguration : IConfigureNamedOptions<AzureADv2Options>
    {
        private readonly IOptions<AzureADv2SchemeOptions> _schemeOptions;

        public AzureADOptionsConfiguration(IOptions<AzureADv2SchemeOptions> schemeOptions)
        {
